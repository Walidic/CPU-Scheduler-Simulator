...
// public GUI(Process[] result, int pnumber, String Sname, float waitTime, float
// turnAroundTime){
...
// graph.setBorder(BorderFactory.createMatteBorder(10, 10, 10, 10,
// Color.WHITE));
...
// statTitle.setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2,
// Color.BLACK));
